...
?>
  ...
  <form action="especie.php" method="post">
    ...
    <p class="text-center"><strong>Clique abaixo para consultar as espécies cadastradas</strong></p>
    <button type="submit" class="btn btn-secondary btn-block">Consultar</button>
  </form>
  <br>

  <!-- botao de editar -->
  <form action="especie_editar.html" method="post">
    <input type="hidden">
    <p class="text-center"><strong>Clique abaixo para editar as espécies cadastradas</strong></p>
  ...
  <form action="especie.php" method="post">
    ...
    <p class="text-center"><strong>Indique abaixo o codigo da espécie que deseja excluir</strong></p>
    <p>
