    ...
    <main class="form-container">
      <div class="formulario">
        ...
        <form action="consulta.php" method="post">
          ...
          <p class="text-center"><strong>Clique abaixo para consultar as consultas cadastrados</strong></p>
          <button type="submit" class="btn btn-secondary btn-block">Consultar</button>
        </form><br>
        
        <!-- botao de editar-->
        <form action="consultas_editar.php" method="post">
          <input type="hidden">
          <p class="text-center"><strong>Clique abaixo para editar as consultas cadastradas</strong></p>
        ...
        <form action="consulta.php" method="post">
          ...
          <p class="text-center"><strong>Indique abaixo o codigo da consulta que deseja excluir</strong></p>
          <p>
