...
?>
    ...
    <main class="form-container">
      <div class="formulario">
        ...
        <form method="POST" action="medicamento.php">
            <p>
            ...
            <p>
              ...
              <input type="text" name="modo_uso" class="form-control"/>
            </p>
            <p>
                <label>Descrição:</label>
                <textarea class="form-control" rows="6" cols="40" name="descricao"></textarea>   
            </p>    
            <p>
              <label >Preço:</label>
        ...
        <form action="medicamento.php" method="post">
          ...
          <p class="text-center"><strong>Clique abaixo para consultar os medicamentos cadastrados</strong></p>
          <button type="submit" class="btn btn-secondary btn-block">Consultar</button>
        </form><br>

        <!-- botao de editar -->
        <form action="medicamentos_editar.php" method="post">
            <input type="hidden">
            <p class="text-center"><strong>Clique abaixo para editar os medicamentos cadastrados</strong></p>
        ...
        <form action="medicamento.php" method="post">
          ...
          <p class="text-center"><strong>Indique abaixo o codigo da medicmento que deseja excluir</strong></p>
          <p>
