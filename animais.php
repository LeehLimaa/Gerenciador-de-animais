...
?>
  ...
  <form action="animal.php" method="post">
    ...
    <p class="text-center"><strong>Clique abaixo para consultar os animais cadastrados</strong></p>
    <button type="submit" class="btn btn-secondary btn-block">Consultar</button>
  </form><br>

  <!-- botao de editar-->
  <form action="animais_editar.php" method="post">
    <input type="hidden">
    <p class="text-center"><strong>Clique abaixo para editar os animais cadastradas</strong></p>
  ...
  <form action="animal.php" method="post">
    ...
    <p class="text-center"><strong>Indique abaixo o codigo animal que deseja excluir</strong></p>
    <p>
