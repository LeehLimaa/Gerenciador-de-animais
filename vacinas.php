...
?>
    ...
    <main class="form-container">
      <div class="formulario">
        ...
        <form method="POST" action="vacina.php">
            <p>
                <label >Vacina:</label>
                <input type="text" name="vacina" class="form-control"/>
            </p>
            <p>
                <label >Marca:</label>
        ...
        <!-- botao de consultar -->
        <form action="vacina.php" method="post">
          <input type="hidden" name="operacao" value="mostrar">
          <p class="text-center"><strong>Clique abaixo para consultar as vacinas cadastrados</strong></p>
          <button type="submit" class="btn btn-secondary btn-block">Consultar</button>
        </form><br>

        <!-- botao de editar -->
        <form action="vacinas_editar.php" method="post">
            <input type="hidden">
            <p class="text-center"><strong>Clique abaixo para editar as vacinas cadastradas</strong></p>
        ...
        <form action="vacina.php" method="post">
          ...
          <p class="text-center"><strong>Indique abaixo o codigo da vacina que deseja excluir</strong></p>
          <p>
