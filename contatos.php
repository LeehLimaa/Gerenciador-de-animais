...
<body>
  ...
  <form method="POST" action="contato.php">
    ...
    <p>
      ...
      <textarea class="form-control" rows="6" cols="40" name="mensagem"></textarea>
    </p>
  ...
  <form action="contato.php" method="post">
    ...
    <p class="text-center"><strong>Clique abaixo para consultar as mensagens cadastradas</strong></p>
    <button type="submit" class="btn btn-secondary btn-block">Consultar</button>
  </form><br>

  <form action="contato_editar.html" method="post">
    <input type="hidden">
    <p class="text-center"><strong>Clique abaixo para editar as mensagens cadastradas</strong></p>
    <button type="submit" class="btn btn-secondary btn-block">Editar</button>
  </form><br>

  <form action="contato.php" method="post">
    <input type="hidden" name="operacao" value="excluir" />
    <p class="text-center"><strong>Indique abaixo o codigo da mensagem que deseja excluir</strong></p>
    <p>
