...
?>
  ...
  <main class="form-container">
    <div class="formulario">
      ...
      <form method="POST" action="banho_tosa.php">
        <p>
      ...
      <form action="banho_tosa.php" method="post">
        ...
        <p class="text-center"><strong>Clique abaixo para consultar os procedimentos cadastrados</strong></p>
        <button type="submit" class="btn btn-secondary btn-block">Consultar</button>
      </form>
      <br>
      <!-- botao de editar-->
      <form action="banhos_tosas_editar.php" method="post">
        <input type="hidden">
        <p class="text-center"><strong>Clique abaixo para editar os procedimentos cadastrados</strong></p>
      ...
      <form action="banho_tosa.php" method="post">
        ...
        <p class="text-center"><strong>Indique abaixo o codigo procedimento que deseja excluir</strong></p>
        <p>
