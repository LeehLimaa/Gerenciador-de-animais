  ...
  <!-- Fim do menu -->
    ...
    <main class="form-container">
        ...
        <?php
          ...
          $sql_cod = "SELECT * FROM vacinas ORDER BY vacina ASC";
    ...
    <input type="hidden" name="operacao" value="editar" />
      <p>
        <label>Código:</label>
        <input type="text" name="ID_atendimento" class="form-control"/>
      </p>
      <p>
        <label>Data:</label>
          ...
          <select class="form-control" name="vacinas">
            <option value="">Selecione uma das opções</option>
              <?php while($vacinas = $sql_query_vacinas->fetch_assoc()) {?>
                <option value ="<?php echo $vacinas['ID_vacina']; ?>"><?php echo $vacinas['vacina']?></option><?php } ?>
          </select>
      </p>
      <p>
