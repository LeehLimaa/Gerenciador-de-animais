...
?>
        ...
        <form method="POST" action="funcionario.php">
            ...
            <p>
              <label>Salario:</label>
              <input type="text" name="salario" class="form-control" placeholder="R$"/>
            </p>
            <p>
              <label>Função:</label>
              <select class="form-control" name="funcao">
                ...
                <option value="Banhista e Tosador">Banhista e Tosador</option>
          ...
          <form action="funcionario.php" method="post">
            ...
            <p class="text-center"><strong>Clique abaixo para consultar os funcionários cadastrados</strong></p>
            <button type="submit" class="btn btn-secondary btn-block">Consultar</button>
          </form><br>
          
          <form action="funcionarios_editar.html" method="post">
            <input type="hidden">
            <p class="text-center"><strong>Clique abaixo para editar os funcionários cadastrados</strong></p>
            <button type="submit" class="btn btn-secondary btn-block">Editar</button>
          </form><br>

          <form action="funcionario.php" method="post">
            <input type="hidden" name="operacao" value="excluir"/>
            <p class="text-center"><strong>Indique abaixo o codigo do funcionário que deseja excluir</strong></p>
            <p>
